...
enum ImGuiBackendFlags_
{
    ...
    ImGuiBackendFlags_RendererHasVtxOffset  = 1 << 3    // Backend UIRenderer supports ImDrawCmd::VtxOffset. This enables output of large meshes (64K+ vertices) while still using 16-bit indices.
};
...
struct ImGuiIO
{
    ...
    // Optional: Platform/UIRenderer backend name (informational only! will be displayed in About Window) + User data for backend/wrappers to store their own stuff.
